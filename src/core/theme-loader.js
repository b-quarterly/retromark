...
class ThemeManager {
  ...
  async loadThemeVariables() {
    ...
    if (this.config.typography) {
      ...
      if (font) {
        if (font.body) this.themeVariables['font-body'] = font.body;
        if (font.headings) this.themeVariables['font-headings'] = font.headings;
        if (font.code) this.themeVariables['font-code'] = font.code;
      }
      if (sizes) {
        if (sizes.base) this.themeVariables['base-font-size'] = sizes.base;
        if (sizes.h1) this.themeVariables['h1-size'] = sizes.h1;
        if (sizes.h2) this.themeVariables['h2-size'] = sizes.h2;
        if (sizes.h3) this.themeVariables['h3-size'] = sizes.h3;
        if (sizes.max_width) this.themeVariables['max-content-width'] = sizes.max_width;
        if (sizes.line_height) this.themeVariables['line-height'] = sizes.line_height;
      }
    }
   ...
   */
  loadCustomCss() {
    if (!this.config.custom?.css) return;
   ...
   */
  getMathCss() {
    if (this.config.math?.engine !== 'katex') return '';
